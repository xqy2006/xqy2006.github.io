...
export default defineUserConfig({
  ...
  theme: plumeTheme({
    copyright: false,
    footer: { message: "xqy2006's blog"},
    /* 添加您的部署域名, 有助于 SEO, 生成 sitemap */
    hostname: 'https://blog.xuqinyang.top',
    ...
    plugins: {
       ...
       */
       shiki: {
         ...
         languages: ['shell', 'bash', 'typescript', 'javascript','python', 'json', 'yaml', 'css', 'html', 'markdown', 'sql', 'java', 'go', 'rust', 'kotlin', 'swift', 'php', 'ruby', 'c', 'cpp', 'csharp', 'scala', 'groovy', 'perl', 'lua', 'r', 'dart', 'haskell', 'ocaml', 'plaintext'],
